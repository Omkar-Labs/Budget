      ...
      <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5} glareEnable={true} glareMaxOpacity={0.45} scale={1.05} perspective={1500} className='w-full h-full flex items-center justify-center'>
        <Card size="default" className="w-full h-full p-3  bg-white/10 backdrop-blur-xl border border-white/20  shadow-[0_0_30px_rgba(255,0,255,0.1)]">
          <CardHeader className=" flex items-center justify-start">
            <CardTitle className="text-pink-300 text-2xl ">TOTAL BALANCE</CardTitle>
          </CardHeader >
          <hr className='' />
          <CardContent className=" ">
            <h1 className='text-7xl font-bold text-white text-start  font-sans'>{symbol} {counter}</h1>
            <Player
              autoplay
              loop
              src={Financial}
              className='h-full w-1/2 mx-auto z-0 absolute -bottom-7 right-36 opacity-50 @lg:h-50 @lg:w-50'
            >
            </Player>
