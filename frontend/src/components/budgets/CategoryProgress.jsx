...
const CategoryProgress = () => {
    ...
    return (
        <div className='w-full h-auto lg:h-full py-6 lg:py-0 relative flex flex-col items-center justify-start  bg-white/10 backdrop-blur-xl rounded-lg  border-white/20  shadow-[0_0_30px_rgba(255,0,255,0.1)] pt-4'>
            <h1 className='text-white text-lg lg:text-xl font-bold mb-4'>Category-wise Budget</h1>
